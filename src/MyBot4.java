...
public class MyBot4 {
    ...
    private final static int SAFETY_FACTOR = 30;

    public static void main(final String[] args) {
        final Networking networking;
        networking = new Networking();
        final GameMap gameMap = networking.initialize("Speed Sensitive");
                ...
                if (numPlayers == 2) {
                    ...
                    if (allPlanetsBeenCaptured) {
                        ...
                        if (numMyPlanets <= 2) {
                            ...
                            if (numMyPlanets == 0) {
                                nearestUnowned = GenNav.nearestPlanetMining(ship, me, gameMap, false);
                            } else {
                        ...
                        ThrustMove newThrustMove = null;
                        if (priorityShip != null && (shipCloser || attackAlert || !planetSafe)) {
                            //if nearest enemy ship exists navigate to attack
